...
//go:generate env CC=/opt/homebrew/opt/llvm/bin/clang go run github.com/mhr3/goruntool@v0.1.1 github.com/tsenart/gocc/cmd/gocc@fix-arm64-stack-transform csrc/ascii_neon_memchr.c -l -p ascii -o ./ -a arm64 -O3
